...
class StudentTeacherRequestAdapter(
    private val context: Context,
//    private var mListener: OnItemClickListener,
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
) :
    RecyclerView.Adapter<StudentTeacherRequestAdapter.ViewHolder>() {
...
//        fun onCardClick(position: Int, reportArrayList: ArrayList<ReportResponse.Data>,reportNameRoomList: List<CreateReportRoomResponse>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomDriverOrderLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomDriverOrderLayoutBinding) :
