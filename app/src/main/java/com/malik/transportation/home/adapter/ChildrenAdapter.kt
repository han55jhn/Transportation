...
import com.malik.transportation.databinding.CustomAddChildrenLayoutBinding
...
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomAddChildrenLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomAddChildrenLayoutBinding) :
        RecyclerView.ViewHolder(binding.root) {
        init {
            binding.cardView.setOnClickListener {
                mListener.onChildClick(adapterPosition)
            }
