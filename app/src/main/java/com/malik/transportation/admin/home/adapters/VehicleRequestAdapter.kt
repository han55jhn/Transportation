...
class VehicleRequestAdapter(
    private val context: Context,
    private var mListener: OnItemClickListener,
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
) :
    RecyclerView.Adapter<VehicleRequestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomVehicleRequestLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomVehicleRequestLayoutBinding) :
