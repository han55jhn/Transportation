...
class EducationalInstitutionAdapter(
    private val context: Context,
    private var mListener: OnItemClickListener,
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
) :
    RecyclerView.Adapter<EducationalInstitutionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomEducationalLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomEducationalLayoutBinding) :
