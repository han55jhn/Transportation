...
class StudentsRequestAdapter(
    private val context: Context,
    private var mListener: OnItemClickListener,
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
) :
    RecyclerView.Adapter<StudentsRequestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomStudentRequestsLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomStudentRequestsLayoutBinding) :
