...
import com.malik.transportation.databinding.CustomCompanyDriversRequestLayoutBinding
...
class CompanyDriverRequestAdapter(
    private val context: Context,
    private var mListener: OnItemClickListener,
//    private val reportArrayList: ArrayList<ReportResponse.Data>,
) :
    RecyclerView.Adapter<CompanyDriverRequestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            CustomCompanyDriversRequestLayoutBinding.inflate(
...
//            viewHolder.bind(report)
    ...
    inner class ViewHolder(private val binding: CustomCompanyDriversRequestLayoutBinding) :
